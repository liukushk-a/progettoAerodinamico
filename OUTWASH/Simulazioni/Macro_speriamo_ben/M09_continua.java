// Simcenter STAR-CCM+ macro: M09_continua.java
...
public class M09_continua extends StarMacro {
  ...
  private void execute0() {
    ...
    velocityProfile_0.getMethod(ConstantVectorProfileMethod.class).getQuantity().setComponentsAndUnits(50.0, 0.0, 0.0, units_2);

    velocityProfile_0.getMethod(ConstantVectorProfileMethod.class).getQuantity().setComponentsAndUnits(20.0, 20.0, 0.0, units_2);
